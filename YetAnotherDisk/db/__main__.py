...
from YetAnotherDisk.utils.pg import DEFAULT_PG_URL, make_alembic_config
...
def main():
    ...
    alembic.parser.add_argument(
        '--pg-url', default=os.getenv('YETANOTHERDISK_PG_URL', DEFAULT_PG_URL),
        help='Database URL [env var: YETANOTHERDISK_PG_URL]'
    )
