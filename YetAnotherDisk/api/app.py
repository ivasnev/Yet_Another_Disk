...
from YetAnotherDisk.api.handlers import HANDLERS
from YetAnotherDisk.api.middleware import error_middleware, handle_validation_error
from YetAnotherDisk.api.payloads import AsyncGenJSONListPayload, JsonPayload
from YetAnotherDisk.utils.pg import setup_pg
...
def create_app(args: Namespace) -> Application:
    ...
    setup_aiohttp_apispec(app=app, title='YetAnotherDisk API', swagger_path='/',
